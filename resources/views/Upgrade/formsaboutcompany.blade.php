    ...
    <section class="contactinf flex-column d-flex justify-content-center align-items-center">
        ...
        <div class="contactback">
            <div class="row">
                ...
                <form method="POST" action="{{ route('showUpgradeForm.store',['id'=> $serviceupgrade->id]) }}">
                    @csrf
                    <input type="hidden" name="selected_service_id" value="{{ $serviceupgrade->id }}">
                    <input type="" id="selected_service" name="selected_service" value="{{ $serviceupgrade->service_type }}">
                    ...
                    <div class="mt-4">
                        <label for="products_services" class="form-label labeltitle">
                            @if ($serviceupgrade->service_type == 'web')
                    ...
                    <div class="mb-3">
                        <label for="others_services" class="form-label labeltitle">
                            @if ($serviceupgrade->service_type == 'Web Site')
                            Other Services
                           @else
