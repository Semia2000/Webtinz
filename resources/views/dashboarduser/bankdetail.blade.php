                ...
                <div class="row row-cols-1 row-cols-md-2 g-4">
                    <div class="col-4 me-3">
                        ...
                        <div class="radiochoice d-flex  flex-column justify-content-center">
                            ...
                            <div class="radiocheck d-flex align-items-center mb-3" checked
                            style="background-color:#F05940
                                    ;width:100%; padding:10px 0px">
                            <input type="radio" class="ms-1 form-check-input" id="radio1" name="optradio" value="option1"
                                checked>
                            <label class="form-check-label" for="radio1" style="color: white;font-weight:500">Local bank
                            </label>
                        </div>
                        </div>
                    </div>
