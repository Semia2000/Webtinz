    ...
    <section class="contactinf flex-column d-flex justify-content-center align-items-center">
        ...
        <div class="contactback ">
            <div class="row">
                ...
                <form method="get" action="updateSummary">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row" id="contact-info">
                        <div class="row mb-4">
                            <div class="col">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="company_name" name="name" value="{{ $company->name }}" placeholder="Company Name" readonly>
                            ...
                            <div class="col">
                                ...
                                <div class="input-group position-relative">
                                    <input type="email" class="form-control pr-5" id="email" name="email" value="{{ $company->email }}" placeholder="Email Address" readonly>
                        ...
                        <div class="row mb-4">
                            <div class="col">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="address" name="address" value="{{ $company->address }}" placeholder="Street Address" readonly>
                                    <i class="bi bi-geo-alt position-absolute top-50 end-0 me-2 translate-middle-y"></i>
                                </div>
                            </div>
                            <div class="col">
                                <label for="country">Country<span class="required">*</span></label>
                                <select id="country" class="form-select form-select-md" name="country" value="{{ old('country', $company->country) }}" disabled>
                        ...
                        <div class="row mb-4">
                            <div class="col">
                                ...
                                <select id="state" class="form-select form-select-md" name="state" value="{{ old('state', $company->state) }}" disabled>
                            ...
                            <div class="col">
                                ...
                                <div class="input-group">
                                    <input type="tel" class="form-control pr-5" id="phone" name="tel" value="{{ $company->tel }}" placeholder="Phone" readonly>
                    ...
                    <div class="row" id="company-info">
                        ...
                        <div class="mb-3">
                            ...
                            @foreach (explode(',', $websites->sector) as $sector)
                            <div class="row">
                                <div class="col mt-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="{{ $sector }}" name="sector[]" id="sector_{{ strtolower(str_replace(' ', '_', $sector)) }}" checked disabled>
                                        <label class="form-check-label" for="sector_{{ strtolower(str_replace(' ', '_', $sector)) }}">
                                            {{ $sector }}
                                        </label>
                                    </div>
                                </div>
